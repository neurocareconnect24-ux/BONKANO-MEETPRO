...
import 'package:bonkano_meet_pro/locale/language_en.dart';
...
bool get isFCMSupported => !kIsWeb && (Platform.isAndroid || Platform.isIOS || Platform.isMacOS);
      ...
      child: Obx(
        () => GetMaterialApp(
          ...
          builder: (context, child) {
            // ACCESSIBILITY FIX P0-8: Permettre le zoom texte pour les utilisateurs malvoyants
            // Avant: TextScaler verrouillé à 1.0, empêchant tout agrandissement
            // Après: Texte peut être agrandi jusqu'à 1.4x (conformité accessibilité)
