class DoctorSessionResp {
  String message;
  List<DoctorSessionModel> data;
  bool status;

  DoctorSessionResp({
    this.message = "",
    this.data = const <DoctorSessionModel>[],
    this.status = false,
  });

  factory DoctorSessionResp.fromJson(Map<String, dynamic> json) {
    return DoctorSessionResp(
      message: json['message'] is String ? json['message'] : "",
      data: json['data'] is List
          ? List<DoctorSessionModel>.from(json['data'].map((x) => DoctorSessionModel.fromJson(x)))
          : [],
