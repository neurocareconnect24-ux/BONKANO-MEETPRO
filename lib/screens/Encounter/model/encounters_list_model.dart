...
class EncounterElement {
  ...
  EncounterElement({
    ...
    this.description = "",
    this.status = false,
    this.encounterType = "consultation",
    this.typeLabel = "",
  });
  ...
  factory EncounterElement.fromJson(Map<String, dynamic> json) {
    return EncounterElement(
      ...
      encounterType: json['encounter_type'] is String ? json['encounter_type'] : "consultation",
      typeLabel: json['type_label'] is String ? json['type_label'] : "",
    );
  }
